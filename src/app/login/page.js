...
import { Mail, Lock, User, Phone, MapPin, ArrowRight, Building2, Award, User as UserIcon, Eye, EyeOff } from 'lucide-react'
      ...
      <div className="w-full max-w-md">
        ...
        <div className="bg-white rounded-3xl shadow-xl p-8">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            {/* Coach: Years + Province/City/District */}
