...
import { Search, Send, Phone, Video, MoreVertical, User, MessageCircle } from 'lucide-react'
  ...
  return (
    <div className="min-h-screen bg-gray-100">
      <div className="max-w-6xl mx-auto h-screen py-4 px-4">
        <h1 className="text-2xl font-bold mb-4 text-gray-800">消息</h1>
        
        <div className="bg-white rounded-2xl overflow-hidden shadow-sm h-[calc(100vh-100px)] flex">
          {/* Chat List */}
              ...
              <>
                ...
                <div className="flex-1 overflow-y-auto p-4 space-y-4 bg-gray-50">
                  {mockMessages.map(msg => (
                    ...
                    >
                      ...
                      >
                        <p>{msg.text}</p>
                        <div className={`text-xs mt-1 ${msg.sender === 'me' ? 'text-green-100' : 'text-gray-400'}`}>
                          {msg.time}
                        </div>
                      </div>
                    </div>
                ...
                <div className="p-4 bg-white border-t">
                  <div className="flex items-center gap-2">
                    ...
                    <button
                      onClick={sendMessage}
                      className="p-3 bg-primary text-white rounded-full hover:bg-green-600 transition"
                    >
